...
<body>
    <nav class="flex flex-col gap-y-8 bg-[#3BAFAB] md:gap-y-14">
        ...
        <div class="flex flex-row justify-center gap-x-10 text-white mb-2 md:text-[25px] md:gap-x-32">
            ...
            <a href="/minuman" class="underline decoration-[#FDC300] decoration-4">Minuman</a>
    ...
    <footer class="bg-[#3BAFAB] py-4 mt-10 md:mt-60">
        <div class="grid grid-cols-2 h-full border-b-2 border-t-2">
            ...
            <div class="flex flex-col gap-y-5 text-center text-white h-full px-4">
                ...
                <a href="/tentangKami" class="text-[10px] self-center md:text-[25px] font-bold flex"><img src=""
                        alt="" class="w-[11px] h-[10px] md:h-[25px] md:w-[25px]" />
