    ...
    <nav class="bg-[#3BAFAB] h-auto relative" x-data="{ isOpen: false }">
      <div class="px-4 mx-auto relative">
        ...
        <div class="flex items-center h-16 md:h-40 relative">
          ...
          <div
            x-data="{ isOpen: false }"
            class="hidden md:block absolute right-56"
          >
            <div>
              <button
                @click="isOpen = !isOpen"
            ...
            >
              ...
              <a
                href="/homeadmin/beritaUtamaadmin"
        ...
        <div class="flex items-center justify-center flex-grow">
          <div class="hidden md:block mb-2 mt-6">
            <div
              class="flex items-baseline space-x-32 justify-center text-[25px]"
            >
              <a href="/homeadmin" class="text-white font-bold"
                ><img src="" alt="" />BERANDA</a
              >
              <a href="/homeadmin/beritaUtamaadmin" class="text-white font-bold"
                ><img src="" alt="" />BERITA</a
              >
              <a href="/homeadmin/makananadmin" class="text-white font-bold"
                ><img src="" alt="" />UMKM</a
              >
              <a href="/homeadmin/tentangKamiadmin" class="text-white font-bold"
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="flex flex-row">
          ...
          <div
            x-data="{ isOpen: false }"
            class="absolute px-2 pt-2 pb-3 right-2"
          >
            <div>
              <button
                @click="isOpen = !isOpen"
