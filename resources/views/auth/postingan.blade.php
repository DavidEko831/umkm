  ...
  <body>
      ...
      <main class="mt-6 flex flex-col gap-y-6">
        ...
        <div class="rounded-2xl bg-[#76C6F8]">
          ...
          <div class="my-auto mb-4 ml-6 flex items-center">
            <img src="/gambar/paperbag.jpeg" alt="" class="h-[97px] w-[92px]" />

            <div class="mx-[16px]">
              <h1 class="text-[20px] font-bold text-[#016997]">
                Paperbag hasil olahan dari Bank Sampah
              </h1>
              <p class="text-[12px]">
                Desa Semambung, Wonoayu, mempunyai segudang prestasi. Salah
                satunya yaitu Bank Sampah. Bank Sampah sendiri ternyata memiliki
                perbedaan sendiri. Perbedaannya dimulai dari sampah organik,
                anorganik dan B3 atau mudah terbakar.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-2xl bg-[#76C6F8]">
          ...
          <div class="mb-4 ml-6 flex flex-row">
            ...
            <div class="ml-2 flex flex-col gap-y-1 font-bold">
              <h3 class="text-[13px] text-[#016997]">RW 3</h3>
              <p class="text-[10px]">Paperbag PSD</p>
              <p class="text-[10px]">Rp. 7.000</p>
              <p class="text-[10px]">Jl. Aja Dulu</p>
              <a href="wa.me/6285850731934" class="flex flex-row text-[10px]"
                >085850731934<img
                  src="/gambar/wa.svg"
                  alt=""
    ...
    <section class="hidden flex-col md:flex">
      ...
      <div class="flex h-screen flex-row">
        <nav
          class="w-4/12 bg-[#3BAFAB] text-center text-[32px] font-bold text-white"
        >
          <div
          ...
          >
            <a href="/homeadmin/formumkm" class="">UMKM</a>
          </div>
          ...
          <div class="mx-auto w-11/12 rounded-2xl bg-[#76C6F8]">
            ...
            <div class="mb-4 ml-6 flex flex-row items-center">
              ...
              <div class="mx-[16px]">
                ...
                <p class="text-[24px]">
                  Desa Semambung, Wonoayu, mempunyai segudang prestasi. Salah
                  satunya yaitu Bank Sampah. Bank Sampah sendiri ternyata
                  memiliki perbedaan sendiri. Perbedaannya dimulai dari sampah
                  organik, anorganik dan B3 atau mudah terbakar.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="mx-auto w-11/12 rounded-2xl bg-[#76C6F8]">
            ...
            <div class="mb-4 ml-6 flex flex-row items-center">
              <img
                ...
                class="h-[178px] w-[189px]"
              />
              <h3 class="ml-1 text-[32px] font-bold text-[#016997]">RW 3</h3>
              <div class="ml-2 ml-8 flex flex-col gap-y-3 font-bold">
                <p class="text-[20px]">Paperbag PSD</p>
                <p class="text-[20px]">Rp. 7.000</p>
                <p class="text-[20px]">Jl. Aja Dulu</p>
                <a href="wa.me/6285850731934" class="flex flex-row text-[20px]"
                  >085850731934<img
                    src="/gambar/wa.svg"
                    alt=""
