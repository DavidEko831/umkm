    ...
    <footer class="bg-[#3BAFAB] py-4 mt-10 md:mt-60">
      <div class="grid grid-cols-2 h-full border-b-2 border-t-2">
        ...
        <div class="flex flex-col gap-y-5 text-center text-white h-full px-4">
          ...
          <a href="makananadmin" class="text-[10px] md:text-[24px]"
            >Makanan</a
          >
          <a href="minumanadmin" class="text-[10px] md:text-[24px]"
            >Minuman</a
          >
          <a href="konveksiadmin" class="text-[10px] md:text-[24px]"
            >Konveksi</a
          >
          <a
