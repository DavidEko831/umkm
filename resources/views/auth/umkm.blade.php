...
<body class="">
    ...
    <section class="md:hidden">
        <nav class="flex flex-col gap-y-20 bg-[#3BAFAB] md:gap-y-14">
            ...
            <div class="mb-2 flex flex-row justify-center gap-x-10 text-[14px] font-bold text-white">
                ...
                <a href="/homeadmin/tambahProduk">Tambah <br />
                    Produk</a>
            ...
            @foreach ($umkms as $product)
                <div class="rounded-2xl bg-[#76C6F8]">
                    ...
                    <div class="mr-4 flex justify-end gap-x-2 pt-2">
                        ...
                        <a href="{{ route('umkm.delete', $product->id_umkm) }}"
                    ...
                    <div class="mb-4 ml-6 flex flex-row">
                        ...
                        <div class="ml-2 flex flex-col gap-y-1 font-bold">
                            ...
                            <a href="{{ $product->telp }}" class="flex flex-row text-[10px]">{{ $product->telp }}<img
                                    src="/gambar/wa.svg" alt=""
                                    class="float-right h-[19px] w-[12px] pb-[8px]" /></a>
                        </div>
                    </div>
    ...
    <section class="hidden flex-col md:flex h-full">
        ...
        <div class="flex h-full flex-row">
            <nav class="w-4/12 bg-[#3BAFAB] text-center text-[32px] font-bold text-white h-screen">
                    ...
                    <div class="mx-auto w-11/12 rounded-2xl bg-[#76C6F8]">
                        ...
                        <div class="mb-4 ml-6 flex flex-row items-center">
                            ...
                            <div class=" ml-8 flex flex-col gap-y-3 font-bold">
                                ...
                                <a href="{{ $product->telp }}"
                                    class="flex flex-row text-[20px]">{{ $product->telp }}<img src="/gambar/wa.svg"
                                        alt="" class="float-right h-[23px] w-[23px]" /></a>
                            </div>
                        </div>
