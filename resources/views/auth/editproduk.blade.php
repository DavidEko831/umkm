  ...
  <body class="bg-[#3BAFAB] flex flex-col items-center">
    ...
    >
      ...
      <form action="{{ route('umkm.update', $umkms->id_umkm) }}" method="POST" enctype="multipart/form-data"class="mt-10 md:mt-14 flex flex-col gap-y-2 md:h-auto md:w-10/12 mx-auto">
        ...
        <input type="text" name="telp" class="w-full h-[54px] md:h-[61px] border-2 outline-none border-[#A08D8D] placeholder:pl-3 md:text-[32px] focus:placeholder:text-transparent md:placeholder:text-[32px] rounded-[12px]" placeholder="Masukkan nomor telpon" />
